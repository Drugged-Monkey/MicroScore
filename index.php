...
<body>
    ...
    <table id="mainTable">
        ...
        <tbody data-bind="foreach: teams">
            <tr>
                <td class="headcol" data-bind="text: $index() + 1" class="not-important"></td>
                <td class="headcol" data-bind="text: place"></td>
                <td class="headcol" data-bind="text: teamName"></td>
                <td class="headcol" data-bind="text: wins"></td>
                <td class="headcol" data-bind="text: draws"></td>
                <td class="headcol" data-bind="text: loses"></td>
                <td class="headcol" data-bind="text: points"></td>
                <td class="headcol" data-bind="text: totalTours"></td>
                <!--<td>
